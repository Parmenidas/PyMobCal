'''
Test of the full software with verbose output.
We only read the first two structures (icoord=2,hardcoded)
...
if InputData.icoord==1:
    ...
    if ehsm[0]!=0:
        ...
        print(' average EHS cross section ={: .4E}'.format(ehsm[0]*1e20),file=fout)
